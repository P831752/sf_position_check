    ...
    function (Controller, Fragment, JSONModel, History, ODataModel, UI5Date, MobileLibrary, Uploader, Item, MessageToast, MessageBox, MenuItem) {
        "use strict";
            ...
            onGraduationReset: function () { 
                ...
                oView.byId("opsGraduation1").setVisible(false);  
            ...
            onGraduationAdd: function () { 
                var that = this;
                MessageBox.confirm("Are you sure you want to add another Graduate ?", {
                    actions: [MessageBox.Action.OK, MessageBox.Action.CANCEL],
                    emphasizedAction: MessageBox.Action.OK,
                        onClose: function (sAction) {
                            //MessageToast.show("Action selected: " + sAction);
                            if (sAction != "OK") {
                                ...
                                that.getView().byId("opsGraduation1").setVisible(true); 
                                that.getView().byId("opsGraduationAttach").setVisible(true); 
                                //that.getView().byId("opsTradeCertificate").setVisible(false); 
                            }
                        },                    
                });                    
            ...
            onGraduationDelete1: function () { 
                this.getView().byId("idGraduationTitle").setVisible(true);   
                this.getView().byId("opsGraduation1").setVisible(false); 
...
/*                // var oFile = oEvent.getParameter("file");
            ...
            onSSCEdit: function(){
                ...
                oView.byId("iDuration1").setValue("12 months");
            ...
            onGraduationEdit: function() {
                ...
                oView.byId("tStartDate5").setVisible(false);
                oView.byId("tEndDate5").setVisible(false);
                ...
                oView.byId("iStartDate5").setVisible(true);
                oView.byId("iEndDate5").setVisible(true);
                ...
                oView.byId("iInsName5").setValue("Kendriya Vidyalaya");
                oView.byId("iUnivName5").setValue("Karnataka Board");
                oView.byId("iYear5").setValue("2000");
                oView.byId("iCourseType5").setValue("Full Time");
                oView.byId("iDuration5").setValue("12 months");
                oView.byId("iPercentage5").setValue("70.68");
                oView.byId("iCGPA5").setValue("8.45");
                oView.byId("iDivision5").setValue("Ist Class");
            ...
            onDiplomaEdit: function() {
                ...
                oView.byId("iDuration4").setValue("12 months");
            ...
            onEdit: function () {
                ...
                oView.byId("iDuration2").setValue("24 months");
                oView.byId("iPercentage2").setValue("63.7");
                oView.byId("iCGPA2").setValue("7.1");
                oView.byId("iDivision2").setValue("Ist Class");
