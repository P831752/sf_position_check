    ...
    function (Controller, Fragment, JSONModel, History, ODataModel, UI5Date, MobileLibrary, Uploader, Item) {
        "use strict";
            ...
            onInit: function () {
                ...
                var aSubsections = [
                    { title: "Subsection 1", content: "Content for subsection 1" },
                    { title: "Subsection 2", content: "Content for subsection 2" }
                ];
            
                var oSection = this.byId("dynamicSection");
                ...
                // //repeat education
                // var oGraduationModel = new sap.ui.model.json.JSONModel({
                //     Graduation: [
                //         { id: "idGraduation1", title: "Graduation 1", qualification: "Trade Certificate", certificate: "VIII STD", institution: "National Public School", year: "2000" },
                //         { id: "idGraduation2", title: "Graduation 2", qualification: "Technical Diploma", certificate: "XII STD", institution: "Technical College", year: "2005" }
                //     ]
                // });
                // this.getView().setModel(oGraduationModel, "GraduationModel");
